...
# Optimise with: freqtrade hyperopt --strategy IntradayOmni_v1 --spaces buy roi stoploss
...
class IntradayOmni_v1(IStrategy):
    INTERFACE_VERSION: int = 3

    minimal_roi = {"0": 0.12, "60": 0.06, "180": 0.03, "360": 0}
